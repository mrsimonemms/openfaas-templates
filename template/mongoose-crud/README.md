...
See [OpnmFaaS Docs](https://github.com/openfaas/faas-cli/blob/master/guide/TEMPLATE.md) for
full information.

```shell
export OPENFAAS_TEMPLATE_URL=https://github.com/mrsimonemms/openfaas-templates

faas-cli new --lang mongoose-crud user
```

This will create a new instance of this function in `./user`
